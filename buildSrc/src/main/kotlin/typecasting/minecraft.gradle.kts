...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/typecasting.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: typecasting-common-common-refmap.json
        // fixed:   typecasting-common.refmap.json
