...
abstract class TypeCastingModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<TypeCastingModDependenciesExtension>("typecastingModDependencies")
