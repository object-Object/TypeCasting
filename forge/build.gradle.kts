...
loom {
    forge {
        ...
        mixinConfig(
            "typecasting-common.mixins.json",
            "typecasting-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("typecasting.apply-datagen-mixin", "true")
                property("typecasting.$platform-datagen", "true")
            }
        }
    }
}

typecastingModDependencies {
