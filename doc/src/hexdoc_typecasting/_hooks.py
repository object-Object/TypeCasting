...
import hexdoc_typecasting

from .__gradle_version__ import FULL_VERSION, MINECRAFT_VERSION, MOD_ID, MOD_VERSION
from .__version__ import PY_VERSION


class TypeCastingPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return TypeCastingModPlugin(branch=branch)


class TypeCastingModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return MOD_ID
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_typecasting, "_templates"
